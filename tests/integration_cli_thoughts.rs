...
fn test_list_thoughts_with_data() {
    ...
    conn.execute("INSERT INTO thoughts (content) VALUES (?)", params!["First test thought"]).unwrap();
    conn.execute("INSERT INTO thoughts (content) VALUES (?)", params!["Second test thought"]).unwrap();
    conn.execute("INSERT INTO thoughts (content) VALUES (?)", params!["Third test thought"]).unwrap();
